...
process runTxRename {
    ...
    /opt/miniconda3/envs/long_reads/bin/python3 ${projectDir}/original_scripts/rename_gtf_txid.py \
        --gtf ${flair_collapse_gtf} \
        --tx_prefix \$tprefix

    /opt/miniconda3/envs/long_reads/bin/python3 ${projectDir}/original_scripts/rdmap2counts.py \
